...
第四版标识为imaging_four_studies_20260918_v4。根据研究者2026年9月18日决定，取消IMG_ICAS调整项和Apo_AI扩展分析。此前第三版已移除神经酰胺研究及视觉评分定义的重度WMH分析，并新增冠心病史问卷跳答规则。原编号01、02、05、06及四项主要检验保持不变，报告p_holm_four；CEC研究内次要分析BH-FDR家庭不再包含已取消的Apo_AI扩展。修订依据为研究者对分析内容的决定，不以效应或P值筛选变量。旧版结果保留并标为PREVIOUS_VERSION，不与本版混合；本次修订不称为原始预注册方案。
